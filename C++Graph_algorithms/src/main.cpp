...
int main(int argc, char *argv[]) {
	if (argc < 6) {
		printf("Requires four arguments: (1) sequence \"1, 2...\" of the vertices, and (2) edge definitions in \"1-2:3, 2-3:1,...\" form, (3) start point and (4) goal point.\n");
	}
/*
	Graph g;
	Graph_init_empty(&g);
...
"v1,v2,v3,v4,v5,v6" "v1-v2:5,v1-v3:1,v2-v3:3,v2-v4:4,v2-v5:2,v3-v5:6,v4-v5:3,v4-v6:2,v5-v6:1"
*/
