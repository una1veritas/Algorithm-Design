...
void heap_sort(data * a[], long n, lessfunc less);
void selection_sort(data * a[], long n, lessfunc less);
void selection_sort_reverse(data * a[], long n, lessfunc less);
void merge_sort_recursive(data * a[], long n, lessfunc less);
void merge_sort_doubles(data * a[], long n, lessfunc less);
void merge_sort_ldeque(LinkedDeque * a, lessfunc less);
void bubble_sort(data * a[], long n, lessfunc less);
